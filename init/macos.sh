...
# Create backup of defaults
echo "creating backup..."

run_name="$(date +%Y-%m-%d_%H-%M-%S)"
backup_folder="$HOME/.defaults_backup_$run_name"
mkdir -p $backup_folder
for domain in $(defaults domains | sed "s/, / /g")
do
    # call your procedure/other scripts here below
		plist_path="$backup_folder/$domain.plist"
		defaults export $domain $plist_path
done
nvram -p > "$backup_folder/nvram.txt"
pmset -g everything > "$backup_folder/pmset.txt"
...
defaults write com.apple.Safari ProxiesInBookmarksBar '("Top Sites", "Bookmarks Bar")'
...
open "${HOME}/.dotfiles/init/One Dark.itermcolors"
