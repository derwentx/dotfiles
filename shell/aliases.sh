...
# like tail but vim
alias vimtail="$HOME/.vim/bundle/tail-bundle/macros/vim-tail.zsh"
...
## Applications
alias mscore="/Applications/MuseScore\ 2.app/Contents/MacOS/mscore -x 1"
...
## Shell
alias remove="rm -rdf"
alias wipe="ls -A1 | xargs rm -rdf"
# mkcd() { mkdir -p "$@" && cd "$@"; }
alias up="cd .."

alias nc.traditional="nc"


##################################################
# Note:
##################################################
# Looking for a particular functionality?
# Don't forget to check .functions
